...
export default function EditApplicationDialog({
    ...
    const isDirty = useMemo(() => {
        return (
            ...
            hostname.trim() !== application?.hostname ||
            environment !== application?.environment ||
            description.trim() !== application?.description ||
            isActive !== application?.isActive ||
            selectedGroups.length !==  application?.selectedGroups?.length
        );
            ...
            <div class="oj-dialog-body">
                ...
                <form onSubmit={handleSubmit} class="application-form">
                    <oj-form-layout labelEdge="start">
                        ...
                        <div class="oj-form-item">
                            <oj-label for="editAppEnvironment">
                                Environment
                            </oj-label>
                            <oj-select-single
                        ...
                        <div class="oj-form-item">
                            <oj-label for="editAppDescription">
                                Description
                            </oj-label>
                            <oj-input-text

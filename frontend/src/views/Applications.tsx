...
export default function Applications({ path }: Props) {
    ...
    const pageSizeDataProvider = useMemo(() => {
        return new ArrayDataProvider(pageSizeOptions, {
            keyAttributes: "value",
        });
    }, []);
                ...
                <div class="applications-header">
                    <div class="applications-title-block">
                        ...
                        <p class="applications-description">
                            Manage and monitor all your applications in one
                            place.
                        </p>
                    </div>
                        ...
                        <div class="filters-group">
                            ...
                            <oj-c-select-multiple
                                ...
                                onvalueChanged={(event: any) => {
                                    ...
                                    console.log(
                                        "Environment filter changed:",
                                        newValue
                                    );
                                    setEnvironmentFilter(
                                        newValue ?? new Set<string>()
                                    );
                                    setCurrentPage(1);
                                }}
                        ...
                        {!loading && totalCount > 0 && (
                            <div class="oj-flex oj-sm-justify-content-center oj-sm-align-items-center">
                                ...
                                <div class="pagination-info">
                                    Page {currentPage} of{" "}
                                    {Math.ceil(totalCount / pageSize)} • Showing{" "}
